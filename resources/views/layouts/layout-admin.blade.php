  ...
  <section id="container" >
      ...
      *********************************************************************************************************************************************************** -->
      ...
      <header class="header black-bg">
            ...
            <!--logo start-->
            <a href="{{ url('/') }}" class="logo"><b>DASHGUM FREE</b></a>
            <!--logo end-->
          ...
          <div id="sidebar"  class="nav-collapse ">
              ...
              <ul class="sidebar-menu" id="nav-accordion">
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="{{ url('admin/product') }}">Show</a></li>
                          <li><a  href="{{ url('admin/product/create') }}">Create New Product</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="{{ url('admin/category') }}">Show</a></li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                          <li><a  href="{{ url('admin/order') }}">Show</a></li>
                      </ul>
                  </li>
                  <li class="sub-menu">
                      <a href="javascript:;" >
                      ...
                      <ul class="sub">
                         <li><a  href="{{ url('admin/user/show') }}">Show</a></li>
                        <li><a  href="{{ url('admin/user/create') }}">Create New User</a></li>
                      </ul>
                  </li>
                  ...
                  <li class="sub-menu">
                      ...
                      <ul class="sub">
                         <li><a  href="{{ url('admin/review/show') }}">Show</a></li>
                      </ul>
                  </li>
